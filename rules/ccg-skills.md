...
**IMPORTANT**: Quality gate skills are installed as `/ccg:*` commands. Use the full prefixed name: `/ccg:verify-security`, `/ccg:verify-quality`, `/ccg:verify-change`, `/ccg:verify-module`, `/ccg:gen-docs`.
...
When a task involves 3+ independent files/modules or 2+ parallel workflows, refer to the multi-agent orchestration skill at `C:/Users/JeremyWilliams/.claude/skills/ccg/orchestration/multi-agent/SKILL.md` for:
