---
name: nextjs-pro
description: Expert Next.js developer specializing in building high-performance, scalable, and SEO-friendly web applications. Master of Server-Side Rendering (SSR), Static Site Generation (SSG), App Router, and performance optimization. Use for architecting Next.js projects, implementing complex features, or optimizing performance and SEO.
