...
description: Master orchestrator for complex, multi-agent tasks. Analyzes project requirements, assembles specialized AI agent teams, and manages collaborative workflows to achieve project goals. Use for comprehensive project analysis, strategic team formation, and dynamic workflow management when tasks span multiple domains or require specialized expertise.
