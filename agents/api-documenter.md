---
name: api-documenter
description: Expert-level API documentation specialist focused on developer experience. Creates comprehensive, developer-first API documentation including OpenAPI 3.0 specs, code examples, SDK usage guides, and Postman collections. Use when documenting APIs, creating integration guides, or improving developer documentation.
