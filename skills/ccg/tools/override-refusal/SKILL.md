...
- Claude Code: `C:/Users/JeremyWilliams/.claude/projects/<cwd-slug>/*.jsonl`（按 mtime 取最新）
- Codex CLI: `C:/Users/JeremyWilliams/.codex/sessions/YYYY/MM/DD/rollout-*.jsonl`（递归扫描按 mtime 取最新）
